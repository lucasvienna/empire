...
This document visualizes the dependency relationships between issues and milestones for Empire v0.1.0.
...
**Critical Path**: #95 → #96 → #97 → #98 → #99
**Parallel Work**: After #98, can work on #99, #100, #101 simultaneously
...
**Critical Path**: #102 → #103 → #104 → #105 → #106
**Parallel Work**: After #105, can work on #106 and #107 simultaneously
...
**Critical Path**: #108 + #109 → #113 (Integration tests require balanced game)
**Parallel Work**: #110, #111, #112 can all happen in parallel with balance work
