...
(
    ...
    food_cap  INTEGER NOT NULL DEFAULT 1000,
    wood_cap  INTEGER NOT NULL DEFAULT 1000,
    stone_cap INTEGER NOT NULL DEFAULT 1000,
    gold_cap  INTEGER NOT NULL DEFAULT 1000,
